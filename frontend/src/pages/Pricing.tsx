          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {SPECIAL_OFFERS.map((pkg, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8, delay: i * 0.1 }}
                className={`relative p-12 rounded-3xl border ${pkg.popular ? 'border-royal-gold bg-royal-gold/[0.03] shadow-[0_0_50px_rgba(197,160,89,0.1)]' : 'border-white/5 bg-white/[0.01]'
              ...
              >
                ...
                <button
                  ...
                  className={`w-full py-5 rounded-full sans-ui text-[10px] font-black tracking-[0.4em] uppercase transition-all duration-500 border ${pkg.popular
