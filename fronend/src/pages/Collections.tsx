  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className={`relative aspect-[3/4] overflow-hidden rounded-sm border border-white/5 bg-luxury-black/40 backdrop-blur-sm transition-all duration-700 cursor-zoom-in ${
          isHovered ? 'border-royal-gold/40 scale-[1.01] shadow-[0_0_40px_rgba(197,160,89,0.15)]' : ''
        }`}
      >
                  ...
                  <div className="flex flex-col gap-1">
                    {categories.map(cat => (
                      <button 
                        ...
                        className={`w-full text-left px-6 py-3 text-[10px] uppercase tracking-[0.3em] font-bold transition-all duration-300 rounded-sm ${
                          filter === cat ? 'bg-royal-gold text-black' : 'text-white/60 hover:text-white hover:bg-white/5'
                        }`}
                      >
